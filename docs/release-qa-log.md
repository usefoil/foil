...
| Gate | Command | Result | Artifact / notes |
| --- | --- | --- | --- |
| GitHub release assets | `gh release view v1.12.1 --repo mean-weasel/foil --json tagName,url,assets,publishedAt,isDraft,isPrerelease,targetCommitish` | PASS | Release `v1.12.1` is published, not draft, not prerelease, and includes `Foil-1.12.1-macos.dmg`, `Foil-1.12.1-macos.dmg.sha256`, and `appcast.xml`. |
