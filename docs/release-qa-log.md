...
- Known P0/P1 issues: None from CI/local deterministic gates, DMG verification, `/Applications` v1.12.0 cask install/signing smoke, or manual macOS permission/API-key smoke.
