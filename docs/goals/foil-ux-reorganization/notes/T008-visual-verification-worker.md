...
- Foil was stopped after the capture flow to avoid duplicate menu bar instances.

## Artifacts

- `docs/goals/foil-ux-reorganization/notes/visual/ready-menu-host.png`
- `docs/goals/foil-ux-reorganization/notes/visual/setup-needed-menu-host.png`
- `docs/goals/foil-ux-reorganization/notes/visual/onboarding-setup.png`
- `docs/goals/foil-ux-reorganization/notes/visual/settings-transcription.png`
...
Result after capture flow: no running Foil process.
