...
Foil should look and feel like a focused voice-to-paste utility, not a generic settings panel. The visual system should communicate speed, capture, transcription, cleanup, target delivery, and fallback without adding a marketing page, broad asset overhaul, or decorative clutter.
...
- Candidate files: `Foil/MenuBarView.swift`, `Foil/FloatingStatusView.swift`, `Foil/AppState.swift`, focused tests in `FoilTests/AppStateTests.swift` and `FoilUITests/FoilUITests.swift`.
...
- Candidate files: `Foil/DesignSystem.swift` if introduced, `Foil/MenuBarView.swift`, `Foil/OnboardingView.swift`, `Foil/ApiKeySetupView.swift`, `Foil/FloatingStatusView.swift`.
...
- Candidate files: `Foil/MenuBarView.swift`, `Foil/HistoryPopoverView.swift`, `Foil/OnboardingView.swift`, `Foil/SettingsView.swift`, `Foil/ApiKeySetupView.swift`.
...
- Candidate files: `Foil/FloatingStatusView.swift`, `Foil/MenuBarView.swift`, any reusable status surface introduced by V1.
