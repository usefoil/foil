# GroqTalk UX Reorganization

## Objective

Reorganize GroqTalk's setup, menu bar, and Settings UX so first-run setup is guided and resilient, the ready-state menu bar is a lean control center, and durable preferences live in coherent Settings panes.

## Original Request

Use the approved GroqTalk UX reorganization direction to prepare granular, measurable work packages that GoalBuddy Prep can drive with `/goal`.

## Intake Summary

- Input shape: `existing_plan`
- Audience: GroqTalk users and maintainers.
- Authority: `approved`
- Proof type: `test`
...
- Existing plan facts: Preserve `docs/superpowers/specs/2026-05-19-groqtalk-ux-reorganization-design.md` as the source design. Preserve the user's earlier instruction not to run XCUITests unless explicitly authorized.
...
- Use `docs/superpowers/specs/2026-05-19-groqtalk-ux-reorganization-design.md` as the source of truth for UX direction unless the user revises it.
...
`docs/goals/groqtalk-ux-reorganization/state.yaml`
...
```text
/goal Follow docs/goals/groqtalk-ux-reorganization/goal.md.
```
