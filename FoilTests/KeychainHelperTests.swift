...
final class KeychainHelperTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        testDirectory = FileManager.default.temporaryDirectory
            .appendingPathComponent("FoilKeychainHelperTests-\(UUID().uuidString)", isDirectory: true)
        try FileManager.default.createDirectory(at: testDirectory, withIntermediateDirectories: true)
        KeychainHelper.storageDirectoryOverride = testDirectory
        KeychainHelper.serviceOverride = "com.neonwatty.Foil.tests.\(UUID().uuidString)"
