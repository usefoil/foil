...
final class DiagnosticLogTests: XCTestCase {
    ...
    func testExportTextIncludesAppInfoAndRedactedLogs() {
        ...
        let appInfo = DiagnosticAppInfo(
            ...
            architecture: "arm64",
            bundlePath: "/Users/alice/Applications/GroqTalk.app"
        )
        ...
        XCTAssertTrue(export.contains("Bundle Path: /Users/<user>/Applications/GroqTalk.app"))
    ...
    func testSetupReportIncludesProviderStateAndRedactsSecrets() {
        ...
        XCTAssertTrue(report.contains("# GroqTalk Setup Report"))
        XCTAssertTrue(report.contains("- App Version: 1.2.3 (456)"))
        XCTAssertTrue(report.contains("- Bundle Path: /Users/<user>/Applications/GroqTalk.app"))
        ...
        XCTAssertTrue(report.contains("- Input Monitoring: not directly detectable by GroqTalk"))
    ...
    func testSetupReportDescribesLocalWhisperModelPathBoundary() {
        ...
        let appInfo = DiagnosticAppInfo(
            ...
            macOSVersion: "macOS Test",
            architecture: "arm64",
            bundlePath: "/Applications/GroqTalk.app"
        )
        ...
        XCTAssertTrue(report.contains("- Local Model Path: Not stored by GroqTalk; whisper.cpp model files are managed by the local server."))
    }
}
