...
final class FoilUITests: XCTestCase {
    ...
    func testProviderQALocalWhisperSetupHelperShowsModelCommands() {
        ...
        XCTAssertTrue(staticTextLabelOrValueContaining("brew install ffmpeg").waitForExistence(timeout: 2), app.debugDescription)
        ...
        XCTAssertTrue(elementExists(id: "settings.localWhisperFFmpegInstallCommand.copyButton", timeout: 2), app.debugDescription)
